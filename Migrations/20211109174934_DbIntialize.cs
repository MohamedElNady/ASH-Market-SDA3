        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisaMonthEnd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisaYearEnd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisaCVC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VisaHolderName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisaCards", x => x.VisaId);
                    table.ForeignKey(
